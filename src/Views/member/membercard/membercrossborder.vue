    ...
    <aside class="rightcontainer">
      <div class="filterPanel">
        ...
        <div class="panelTitleGroup">
          ...
          <p class="filterSubtitle">ສະມາຊິກລະບົບຊຳລະຂ້າມແດນໃນຮູບແບບ QR Code ລະຫວ່າງປະເທດ</p>
        </div>
        ...
        <div class="searchBox">
          ...
          <input v-model="searchQuery" type="text" class="searchInput" placeholder="ຄົ້ນຫາທະນາຄານ..." />
        </div>
        ...
        <div class="filterGroup">
          <div class="filterGroupHeader">
            ...
            <span class="filterGroupHint">7 ລາຍການ</span>
          </div>
